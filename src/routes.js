...
const { getFundingRequests, getSharePointDocumentLocation, uploadToSharePoint , getDataverseAccessToken ,downloadFromSharepoint,AddORUpdateDocumentType, deleteFileFromSharePoint ,getSharePointAccessToken } = require('./controllers');

const router = express.Router();

// Define routes
router.get('/api/fundingRequests/:name', getFundingRequests);
router.post('/api/getsharePointAccessToken', getSharePointAccessToken);
